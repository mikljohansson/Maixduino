...
#define   REG04_DEF             0x28 /* Always set */
#define   REG04_HFLIP_IMG       0x80 /* Horizontal mirror image ON/OFF */
#define   REG04_VFLIP_IMG       0x40 /* Vertical flip image ON/OFF */
#define   REG04_VREF_EN         0x10
#define   REG04_HREF_EN         0x08
#define   REG04_AEC_SET(x)      VAL_SET(x, 0x3, 0, 0)
#define REG04_SET(x)        (REG04_DEF|x)
...
#define COM3_DEF        0x38
#define   COM3_BAND_50H        0x04 /* 0 For Banding at 60H */
#define   COM3_BAND_AUTO       0x02 /* Auto Banding */
#define   COM3_SING_FR_SNAPSH  0x01 /* 0 For enable live video output after the
				     * snapshot sequence*/
#define COM3_BAND_SET(x)    (COM3_DEF|x)
...
#define COM8_SET(x)         (COM8_DEF|x)
#define COM8_SET_AEC(r,x)   (((r)&0xFE)|((x)&1))
#define COM9        0x14 /* Common control 9
			  * Automatic gain ceiling - maximum AGC value [7:5]*/
#define COM9_DEF        0x08
...
#define COM9_AGC_SET(x)     (COM9_DEF|(x<<5))
